function [img,H] = iradon2(varargin)
%IRADON2 Compute inverse Radon transform.
%   I = iradon2(R,THETA) reconstructs the image I from projection 
...
figure;plot(filt);hold on; plot(w)
